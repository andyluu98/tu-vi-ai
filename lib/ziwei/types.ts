...
export interface Star {
  ...
  /** Độ sáng đa cấp gốc (chữ Hán: 庙/旺/得/利/平/不/陷...), dùng cho văn bản AI chi tiết hơn brightness 3 mức */
...
export interface Palace {
  ...
  /** Tuần Trung Không Vong (Tử Vi Việt: an theo tuần của can-chi năm sinh) */
  isTuan?: boolean;
  /** Triệt Lộ Không Vong (Tử Vi Việt: an theo can năm sinh) */
  isTriet?: boolean;
  /** Tiểu hạn năm nay có rơi vào cung này không (小限, an theo tuổi hiện tại) */
